...
/**
 * PATCH /api/admin/dictado/[id] — update a dictado
 */
export async function PATCH(
  ...
  try {
    ...
    if (body.textoCompleto !== undefined) data.textoCompleto = body.textoCompleto as string;
    ...
    const item = await prisma.dictadoJuridico.update({
      where: { id },
      data,
    });
...
/**
 * DELETE /api/admin/dictado/[id] — delete a dictado
 */
export async function DELETE(
  ...
  try {
    await prisma.dictadoJuridico.delete({ where: { id } });
