      ...
      <div className="mx-auto flex max-w-[1440px] gap-6 px-4 py-6">
        ...
        <aside className="hidden lg:block w-[280px] shrink-0">
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-border bg-white p-5">
              <div className="h-5 w-24 animate-pulse rounded bg-gray-200 mb-4" />
              <div className="space-y-3">
                <div className="h-10 animate-pulse rounded-lg bg-gray-200" />
                <div className="h-10 animate-pulse rounded-lg bg-gray-200" />
              </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3 lg:hidden">
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                <div className="mx-auto h-6 w-6 animate-pulse rounded bg-gray-200" />
        ...
        <aside className="hidden lg:block w-[260px] shrink-0">
          <div className="rounded-xl border border-border bg-white p-5">
            <div className="h-5 w-20 animate-pulse rounded bg-gray-200 mb-4" />
            <div className="space-y-3">
