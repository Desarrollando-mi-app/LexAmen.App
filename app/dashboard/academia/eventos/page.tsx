...
import { EventosV4Client } from "./eventos-v4-client";

export const metadata = {
  title: "Eventos Académicos — Studio Iuris",
  description:
    "Seminarios, congresos y conferencias jurídicas propuestos por la comunidad.",
};
...
export default async function EventosAcademicosPage() {
  ...
  // Trae eventos próximos aprobados (carga inicial). El cliente puede
  // re-fetch para "pasados" o "mis eventos" vía /api/sala/eventos.
  ...
  return (
    <EventosV4Client
      ...
      userId={authUser.id}
      initialCalendarSourceIds={calendarSourceIds}
    />
  );
}
