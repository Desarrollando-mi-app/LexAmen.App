/** Masthead editorial para Ofertas laborales V4. Server-safe. */
export function MastheadOfertas({
  resultCount,
}: {
  resultCount?: number;
}) {
      ...
      <div className="pt-[14px] flex justify-between items-end gap-6 flex-wrap">
        <div>
          <h1 className="font-cormorant font-semibold text-[56px] leading-[0.95] tracking-[-1px] text-gz-ink m-0">
            <em className="font-medium">¶</em> Ofertas laborales
          </h1>
          <p className="mt-1.5 font-cormorant italic text-[17px] text-gz-ink-mid">
            Cargos vigentes en estudios, empresas y la administración del Estado
          </p>
        </div>
